...
public class PreProcess {
	...
	public boolean execuate(){
		...
		if(takeOffSpeechTags(Config.path+Config.wordSelectedFile,Config.path+Config.destFile)!=true)
			return false;
		if(takeOffSpeechTags(Config.path+"text.speech",Config.path+Config.speechChosendestFile)!=true)
			return false;
